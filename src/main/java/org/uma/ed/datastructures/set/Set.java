...
public interface Set<T> extends Iterable<T> {
  ...
  /**
   * Inserts a new element into the set. If the element already exists, it is replaced by the new one.
   *
  ...
  /**
   * Inserts a sequence of elements into the set. If an element already exists in the set, it is replaced by the new one.
   *
